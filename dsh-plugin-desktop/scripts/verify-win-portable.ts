...
export function verifyWindowsPortable(
  ...
  const executable = entries.find(entry => entry.entryName.replaceAll('\\', '/') === 'ACRYL.exe')
  if (executable === undefined) {
    throw new Error(`Windows portable archive is missing ACRYL.exe: ${portablePath}`)
  }
