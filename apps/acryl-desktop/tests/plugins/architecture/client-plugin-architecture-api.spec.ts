...
import type { CordisPlaneSnapshot } from '../../../src/plugins/architecture/plugin-architecture-contract.ts'
import {
  createPluginArchitectureApi,
  parseCordisPlaneSnapshot,
} from '../../../src/client/plugin-architecture/plugin-architecture-api.ts'
