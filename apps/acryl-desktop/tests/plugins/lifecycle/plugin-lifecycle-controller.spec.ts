...
import { PluginLifecycleController } from '../../../src/plugins/lifecycle/plugin-lifecycle-controller.ts'
import type { DesktopBlendProjection } from '../../../src/profile/desktop-blend.ts'
