...
import type { DesktopRuntime, DesktopTrayItem } from '../../src/shell/runtime.ts'
import type { DesktopProfiles } from '../../src/profile/profile-service.ts'
import { apply, inject, name } from '../../src/profile/profiles.ts'
