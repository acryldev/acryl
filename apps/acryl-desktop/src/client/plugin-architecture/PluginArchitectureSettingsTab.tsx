...
import type { PluginLifecycleLocaleKey } from '../plugin-lifecycle/plugin-lifecycle-locales.ts'
import { pluginLifecycleClasses as css } from '../plugin-lifecycle/plugin-lifecycle-style-classes.ts'
