...
| [ui-library.gallery](packages/client-ui-library/) | client-slot | Build a screen from the ACRYL UI library (@acryl/ui): cards, fields, settings rows, dropdown, segmented tiles, tabs, dialog, color roles and slot helpers. | web desktop | extending.ui-library |
