<!-- Synced from acryl:docs/cordisplugins/development-canvas-plugin.md @ 2f06c20261. Do not edit; run scripts/sync-corpus.mjs. Relative links inside may not resolve here. -->
