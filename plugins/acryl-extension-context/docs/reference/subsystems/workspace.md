<!-- Synced from deepseek-harness:docs/subsystems/workspace.md @ 5dda764ed3. Do not edit; run scripts/sync-corpus.mjs. Relative links inside may not resolve here. -->
