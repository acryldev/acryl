...
| [ACRYL UI library: build screens from ready components](extending/ui-library.md) | Any Web or Desktop UI that has forms, settings, lists, dialogs or tabs: use acryl-ui-web instead of hand-styling; semantic color roles for your own colors. | web desktop tui | all |
