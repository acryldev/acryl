...
import { buildProjectRows, owningWorktree } from '../src/client/workspace/sidebar-model.ts'
import type { RepoState, ShellSnapshot, WorktreeState } from '../src/client/workspace/shell-state.ts'
