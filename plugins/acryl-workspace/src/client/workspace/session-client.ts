import type { WorkspacePtyCommandId, WorkspacePtyView } from '../../workspace-pty-contract.ts'
import type { WorkspacePtyApi } from './pty-api.ts'
...
export class WorkspacePtyClient implements WorkspacePtyApi {
  ...
  async start(commandId: WorkspacePtyCommandId): Promise<WorkspacePtyView> {
