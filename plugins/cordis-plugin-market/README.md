...
Cordis Plugin Market is the open plugin market built into [DSH Desktop](../../README.en.md). It helps people discover community plugins and, on Desktop, install, manage, or remove npm packages that pass the Market Host's checks.
