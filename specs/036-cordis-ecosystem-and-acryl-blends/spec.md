...
| Blend instance capture, persistence, packaging and orchestration design | **Designed; capture, verify, apply and provenance built and tested (2026-09-21).** Ledger, hub publish and lock v2 in blends-core are follow-ons | [`blend-instance-design.md`](blend-instance-design.md), spec 033 |
