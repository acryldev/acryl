...
| Blend instance capture, persistence, packaging and orchestration design | **Designed; capture, verify and provenance built and tested (2026-09-21).** Apply, ledger and hub publish are follow-ons | [`blend-instance-design.md`](blend-instance-design.md), spec 033 |
