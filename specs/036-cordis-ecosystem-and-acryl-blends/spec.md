...
| Blend instance capture, persistence, packaging and orchestration design | **Designed; capture, verify, apply, ledger and provenance built and tested (2026-09-21).** Hub publish and lock v2 in blends-core belong to the `blends` repo (proposal in `blend-instance-design.md`) | [`blend-instance-design.md`](blend-instance-design.md), spec 033 |
