# Implementation Plan: ACR-1 — ACR Cordis plugin + project/room identity + durable state

**Branch**: `002-acr-1-plugin-identity` | **Date**: 2026-08-23 | **Spec**: [spec.md](./spec.md)
...
`docs/cordis/acr_cordis_alignment_audit.md`. In particular, resolve whether the
portable room store is a projection over DSH events or a new ACR-owned domain
