# Implementation Plan: ACR-3 — Relay / structured handoff between DSH-native and external actor

**Branch**: `004-acr-3-relay-handoff` | **Date**: 2026-08-23 | **Spec**: [spec.md](./spec.md)
**Status**: Stub
