...
1. Audit `acryl-cli` direct-host imports, `bootAcrylHarnessProfile`, `bootAcrylWebProfile`, and the profiles/Loader rows they compose. Record the packages genuinely required by either TUI or the existing shared Web host.
