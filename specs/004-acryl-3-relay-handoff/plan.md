# Implementation Plan: ACRYL-3 — Relay / structured handoff between DSH-native and external actor

**Branch**: `004-acryl-3-relay-handoff` | **Date**: 2026-08-23 | **Spec**: [spec.md](./spec.md)
**Status**: Stub
...
Not planned yet. Canonical events stay in the log; handoff is a structured artifact.
