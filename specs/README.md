# specs/ — Spec-Driven Development for ACR
...
Product intent: [`docs/onboarding/orientation_spec_acr.md`](../docs/onboarding/orientation_spec_acr.md).
...
First-pass substrate map: [`docs/acr/ACR_DSH_GAP_ANALYSIS.md`](../docs/acr/ACR_DSH_GAP_ANALYSIS.md).
...
specs/
  ...
  000-wayfinding/          Wayfinder map + decision tickets
    map.md
    issues/NN-slug.md
  001-acr-0-gap-analysis/
  002-acr-1-plugin-identity/
  ...
  014-acr-13-evolution-lab/
...
- **GitHub Issues** on `AgentContextRelay/acr` are optional promotion, not the
