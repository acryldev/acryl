...
- 想安装或开发 DSH 插件的用户：先读[插件开发](plugin-development.md)，再看 [Desktop service contract](../acryl-desktop/docs/plugin-services.md)。
- 想理解启动、profile 和打包边界的维护者：阅读[架构说明](architecture.md)和包级 [README](../acryl-desktop/README.md)。
