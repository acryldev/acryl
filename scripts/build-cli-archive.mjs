...
const version = JSON.parse(readFileSync(join(root, 'apps', 'acryl-cli', 'package.json'), 'utf8')).version
...
async function main() {
  ...
  const launcher = join(root, 'apps', 'acryl-cli', 'scripts', windows ? 'acryl-cli-launcher.cmd' : 'acryl-cli-launcher.sh')
